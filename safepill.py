...
def log_dose_event(owner_phone: str, drug_name: str, scheduled_time: str, taken: bool) -> None:
    ...
    try:
        ...
        supabase.table(DOSE_EVENTS_TABLE).insert({
            "owner_phone": owner_phone,
            "drug_name": drug_name,
            ...
            if med_data_valid:
                ...
                for med in schedule:
                    ...
                    if checked != taken:
                        ...
                        log_dose_event(
                            st.session_state.user_phone, med.get("Tên thuốc", ""), hhmm, checked
                        )
                    ...
                    if missed_clicked:
                        ...
                        log_dose_event(st.session_state.user_phone, drug_name, hhmm, False)
